...
export const MESSAGES = {
  en: {
    ...
    groupSettings: {
      ...
      leave: 'Leave Group',
      leaving: 'Leaving...',
      renameFailed: (error: string) => `Failed to rename group: ${error}`,
      leaveFailed: (error: string) => `Failed to leave group: ${error}`,
    },
    profileSettings: {
      ...
      uploadFailed: (error: string) => `Failed to upload avatar: ${error}`,
      saveFailed: (error: string) => `Failed to update profile: ${error}`,
    },
    workspaceSwitcher: {
      title: 'Workspaces',
  ...
  'zh-TW': {
    ...
    groupSettings: {
      ...
      leave: '離開群組',
      leaving: '離開中...',
      renameFailed: (error: string) => `群組名稱更新失敗：${error}`,
      leaveFailed: (error: string) => `離開群組失敗：${error}`,
    },
    profileSettings: {
      title: '個人設定',
      editProfile: '編輯個人資料',
      ...
      uploadFailed: (error: string) => `頭像上傳失敗：${error}`,
      saveFailed: (error: string) => `更新個人資料失敗：${error}`,
    },
    workspaceSwitcher: {
      title: '工作區',
      emptyTitle: '尚未加入工作區',
